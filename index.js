...
var ballRadius = 14; //define ballRadius
//define x and y
...
function keyDownHandler(e) {
  //this function is executed when the keydown event is pressed
...
function keyUpHandler(e) {
  //this function is executed when the keyup event is pressed
  if (e.key == 'Right' || e.key == 'ArrowRight') {
    rightPressed = false;
  } else if (e.key == 'Left' || e.key == 'ArrowLeft') {
    leftPressed = false;
...
function drawPaddle() {
  //this function will draw the paddle on the screen
  ctx.beginPath();
...
function drawBricks() {
  //this function loops through all the bricks in the array and draws on screen
  for (var c = 0; c < brickColumnCount; c++) {
    for (var r = 0; r < brickRowCount; r++) {
...
function drawScore() {
  //this function creates and updates the score display
  ctx.font = '16px Arial';
  ctx.fillStyle = '#0095DD';
...
function drawLives() {
  //this function creates and updates the lives display
  ctx.font = '16px Arial';
  ctx.fillStyle = '#0095DD';
...
function draw() {
  //we need to define a drawing function to keep updating the canvas drawing on each frame
